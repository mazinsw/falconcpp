...
type
  ...
  protected
    ...
    procedure   GetLocalEntry(MS: TStream; Offset : Integer; HeaderOnly : Boolean; var Result: TLocalFile);
...
procedure TKAZipEntries.GetLocalEntry(MS: TStream; Offset : Integer; HeaderOnly : Boolean; var Result: TLocalFile);
Var
...
begin
  ...
  For X := 0 To Count-1 do
      Begin
        If Assigned(FParent.FOnZipOpen) Then FParent.FOnZipOpen(FParent,X,FParent.FEndOfCentralDir.TotalNumberOfEntriesOnThisDisk);
        GetLocalEntry(MS,Items[X].FCentralDirectoryFile.RelativeOffsetOfLocalHeader,True, Items[X].FLocalFile);
