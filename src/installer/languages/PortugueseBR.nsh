...
; Name of sections
  ...
  !insertmacro LANG_STRING NAME_SecFtm "Modelos básicos"
  !insertmacro LANG_STRING NAME_SecAssoc "Associação de arquivos C/C++"
  !insertmacro LANG_STRING NAME_SecLangFile "Arquivos de linguagens"
  !insertmacro LANG_STRING NAME_SecDeskScut "Atalho na Área de Trabalho"
  !insertmacro LANG_STRING NAME_SecQckLScut "Atalho Rápido"
  !insertmacro LANG_STRING NAME_SecMinGW "MinGW(Compilador)"

; Description of sections

  !insertmacro LANG_STRING DESC_SecCore "IDE C++"
  !insertmacro LANG_STRING DESC_SecFtm "Modelos básicos: Aplicacão de Janelas, Aplicacão Console e Biblioteca de ligação estática e dinâmica(DLL)."
...
; Association file format description
  ...
  !insertmacro LANG_STRING DESC_Assoc_FPK "Pacote de Instalação do Falcon C++"

  !insertmacro LANG_STRING DESC_Assoc_C "Arquivo Fonte C"
  !insertmacro LANG_STRING DESC_Assoc_CPP "Arquivo Fonte C++"
  !insertmacro LANG_STRING DESC_Assoc_H "Arquivo de Cabeçalho"
