...
const
  ...
  CONST_STR_CMPMSG: array[1..MAX_CMPMSG] of TCompilerMessage = (
    ...
    (Expression: '(.*):([0-9]+): warning: unused variable ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: ''(.*)'' was not declared in this scope$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''(.*)'' before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+):([0-9]+): error: macro "(.*)" passed ([0-9]+) arguments, but takes just ([0-9]+)$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+):([0-9]+): error: macro "(.*)" requires ([0-9]+) arguments, but only ([0-9]+) given$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+): error: at this point in file$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: too many arguments to function ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: ''(.*)'' undeclared \(first use in this function\)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''(.*)'' before numeric constant$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: \(Each undeclared identifier is reported only once for each function it appears in\.\)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: statement has no effect$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: passing argument ([0-9]+) of ''(.*)'' makes integer from pointer without a cast$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): note: expected ''(.*)'' but argument is of type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: invalid conversion from ''(.*)'' to ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error:   initializing argument ([0-9]+) of ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: too few arguments to function ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): undefined reference to `(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: cannot convert ''(.*)'' to ''(.*)'' for argument ''(.*)'' to ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: value computed is not used$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: ''(.*)'' is used uninitialized in this function$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: base operand of ''(.*)'' has non-pointer type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+):([0-9]+): error: (.*): No such file or directory$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+): error: ''(.*)'' does not name a type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected initializer before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: a function-definition is not allowed here before ''(.*)'' token expected ''(.*)'' at end of input$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: return makes integer from pointer without a cast$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: overflow in implicit constant conversion$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: integer constant is too large for ''(.*)'' type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+):([0-9]+): warning: integer constant is too large for its type$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+): warning: this decimal constant is unsigned only in ISO C90$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''(.*)'' before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected expression before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): note: ''(.*)'' was declared here$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: statement with no effect$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: lvalue required as left operand of assignment$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: type defaults to ''(.*)'' in declaration of ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: initialization makes integer from pointer without a cast$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+):([0-9]+): warning: character constant too long for its type$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+): error: expected identifier or ''(.*)'' before numeric constant$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''='', '','', '';'', ''asm'' or ''__attribute__'' before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: label ''(.*)'' defined but not used$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: ''(.*)'' has no member named ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: array subscript is not an integer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: too few arguments for format$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: format ''(.*)'' expects type ''(.*)'', but argument ([0-9]+) has type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: switch quantity not an integer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: incompatible type for argument ([0-9]+) of ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected statement before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: control reaches end of non-void function$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: ''(.*)'' may be used uninitialized in this function$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: missing braces around initializer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: (near initialization for ''(.*)'')$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: statement is a reference, not call, to function ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: case label ''(.*)'' not within a switch statement$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected primary-expression before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: no return statement in function returning non-void$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected unqualified-id before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: array subscript is above array bounds$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: suggest parentheses around assignment used as truth value$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: storage size of ''(.*)'' isn''t known$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: invalid application of ''(.*)'' to incomplete type ''(.*)'' $'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: incompatible implicit declaration of built-in function ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: comparison between signed and unsigned integer expressions$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: deprecated conversion from string constant to ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected class-name before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: ISO C\+\+ forbids declaration of ''(.*)'' with no type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):(.*): error: typedef ''(.*)'' is initialized (use decltype instead)$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected constructor, destructor, or type conversion before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected initializer before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected constructor, destructor, or type conversion before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: 'In file included from (.*):([0-9]+):$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):(.*):\((.*)\): first defined here$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): warning: enumeration value ''(.*)'' not handled in switch$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*): In member function ''(.*)'':$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): error: stray ''(.*)'' in program$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''(.*)'' at end of input$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: field width should have type ''(.*)'', but argument ([0-9]+) has type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: subscripted value is neither array nor pointer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: array type has incomplete element type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: too many arguments for format$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: operation on ''(.*)'' may be undefined$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+):([0-9]+): error: unterminated comment$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+):([0-9]+): warning: "(.*)" within comment$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*):([0-9]+):([0-9]+): warning: missing terminating (.*) character$'; FileName: 1; Line: 2; Column: 3),
    (Expression: '(.*): cannot open output file (.*): No such file or directory$'; FileName: 1; Line: 0; Column: 0),
    //(Expression: '(.*): (.*): No such file or directory$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): error: missing terminating (.*) character$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: array size missing in ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: passing argument ([0-9]+) of ''(.*)'' from incompatible pointer type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: return type defaults to ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected identifier or ''(.*)'' before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected identifier or ''(.*)'' at end of input$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected specifier-qualifier-list before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: declaration does not declare anything$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: bit-field ''(.*)'' width not an integer constant$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: ''(.*)'' undeclared here \(not in a function\)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*): warning: ''(.*)'' after last input file has no effect$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*): no input files$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*): preprocessing failed\.$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): error: zero width for bit-field ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: width of ''(.*)'' exceeds its type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: braces around scalar initializer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: initialization from incompatible pointer type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: excess elements in scalar initializer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: left-hand operand of comma expression has no effect$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: assignment from incompatible pointer type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: initializer-string for array of chars is too long$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*): no resources$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): error: invalid application of ''(.*)'' to incomplete type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: void value not ignored as it ought to be$'; FileName: 1; Line: 2; Column: 0),
    (Expression: 'Creating library file: (.*)$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): warning: useless type name in empty declaration$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: unknown conversion type character ''(.*)'' in format$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: parameter name omitted$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected declaration specifiers before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: old-style parameter declarations in prototyped function definition$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: empty declaration$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected declaration specifiers before ''(.*)'' token$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected declaration specifiers or ''(.*)'' before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: storage class specified for parameter ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: duplicate member ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: expected ''(.*)'' before string constant$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: called object ''(.*)'' is not a function$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): Error: too many memory references for `(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: excess elements in array initializer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: size of array ''(.*)'' is too large$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: incompatible types when assigning to type ''(.*)'' from type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: invalid operands to binary (.*) \(have ''(.*)'' and ''(.*)''\)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: assuming signed overflow does not occur when assuming that (.*) is always (.*)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):(.*):\((.*)\): more undefined references to `(.*)'' follow$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '(.*):([0-9]+): warning: extended initializer lists only available with (.*) or (.*)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: type of formal parameter ([0-9]+) is incomplete$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: dereferencing ''(.*)'' pointer$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: request for member ''(.*)'' in something not a structure or union$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: conflicting types for ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): note: previous definition of ''(.*)'' was here$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: useless storage class specifier in empty declaration$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): warning: ''(.*)'' was ignored in this declaration$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: overflow in array dimension$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: dereferencing pointer to incomplete type$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: no matching function for call to ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): note: candidates are: (.*)$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: declaration of ''(.*)'' shadows a parameter$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): error: within this context$'; FileName: 1; Line: 2; Column: 0),
    (Expression: '(.*):([0-9]+): note: previous declaration of ''(.*)'' was here$'; FileName: 1; Line: 2; Column: 0),
