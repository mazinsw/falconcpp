...
type
  ...
  public
    ...
    function GetKnownCharset(out KnownCharsets: WideString): integer;
...
const
  ...
  ABOUT_INFO: rAboutHolder = (
    MajorVersionNr: vi.FILE_VERSION_MAJOR;
    MinorVersionNr: vi.FILE_VERSION_MINOR;
    BuildVersionNr: vi.FILE_VERSION_RELEASE;
...
function TnsUniversalDetector.GetKnownCharset(out KnownCharsets: WideString): integer;
var
