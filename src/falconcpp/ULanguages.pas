...
const
  ...
  CONST_STR_CMPMSG: array[1..MAX_CMPMSG] of TCompilerMessage = (
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: at this point in file$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: too few arguments to function ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: return makes integer from pointer without a cast$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: type defaults to ''(.*)'' in declaration of ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: switch quantity not an integer$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: no return statement in function returning non-void$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: ISO C\+\+ forbids declaration of ''(.*)'' with no type$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: expected ''(.*)'' at end of input$'; FileName: 1; Line: 2; Column: 0),
    ...
    //(Expression: '^([a-zA-Z]?:?[^:]+): (.*): No such file or directory$'; FileName: 1; Line: 0; Column: 0),
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: missing terminating (.*) character$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+): warning: ''(.*)'' after last input file has no effect$'; FileName: 1; Line: 0; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: initializer-string for array of chars is too long$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: empty declaration$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: incompatible types when assigning to type ''(.*)'' from type ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): warning: useless storage class specifier in empty declaration$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: passing ''(.*)'' as ''(.*)'' argument of ''(.*)'' discards qualifiers$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: expected primary-expression before ''(.*)''$'; FileName: 1; Line: 2; Column: 0),
    ...
    (Expression: '^([a-zA-Z]?:?[^:]+):([0-9]+): error: ''(.*)'' has not been declared$'; FileName: 1; Line: 2; Column: 0),
